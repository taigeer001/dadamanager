...
<body class="theme-red">
    ...
    <script>
        function AtContentOpen(dom){
            var href = $(dom).attr("href")
            $(".content .container-fluid ").load(href, function(text, err){
                if(err != "success"){
                    $(".content .container-fluid ").load("/error/404.html")
                }
            })
            return false
        }
        $(".menu .list a").click(function(e){
            ...
            $(".content .container-fluid ").load(href, function(text, err){
                if(err != "success"){
                    ...
                    $(e.currentTarget).parents(".menu").find(".active").removeClass("active")
